---
title: "One in four water modelling papers is in an echo chamber"
subtitle: "R code"
author: "Arnald Puy"
header-includes:
...
# Retrieve and clean Dimensions data
...
## Illustration of a strict and a structural echo chamber

```{r illustration, fig.height=2.3, fig.width=5.5}
...
```{r echo_chambers, dependson=c("dimensions", "source_functions")}
...
## Citations in papers in structural echo chambers vs those that are not

```{r citations, dependson="echo_chambers", fig.height=2.5, fig.width=2.5}
...
```{r plot_echo, dependson="echo_chambers", fig.height=2.5, fig.width=3.5}
...
```{r plot_time, dependson="echo_chambers", fig.height=2.5, fig.width=3}
...
```{r merge_plots, dependson = c("plot_time", "plot_echo", "illustration"), fig.height=4, fig.width=5.5}
...
```{r polar_coordinates, dependson="echo_chambers"}
...
```{r coauthor, dependson="echo_chambers", fig.height=2, fig.width=2}
...
```{r coauthor_model, dependson="echo_chambers", fig.height=3, fig.width=2}
...
```{r bridging_authors, dependson="echo_chambers", fig.height=4, fig.width=4}
...
```{r merge_plots_author, dependson = c("bridging_authors", "coauthor_model", "coauthor"), fig.height=4.2, fig.width=5.5}
